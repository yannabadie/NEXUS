 ...
 * V12.0 RETINA VISUALS: Sovereign SVG Graph Visualization
 *
...
function GraphNodeComponent({ node }: NodeProps) {
...
export function HiveMap() {
  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800 rounded-lg border border-gray-700 overflow-hidden relative">
      {/* Title bar */}
