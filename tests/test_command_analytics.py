...
class TestCommandInvocation:
    ...
    def test_to_dict(self):
        inv = CommandInvocation(command="/evolve", args="--strategy=creative",
                                duration_ms=500.0, success=True, source="repl")
        d = inv.to_dict()
...
class TestUsagePattern:
    ...
    def test_to_dict(self):
        p = UsagePattern(pattern_type="frequent_command", command="/evolve",
                         details="15 invocations", count=15)
        d = p.to_dict()
...
class TestAnalyticsStats:
    ...
    def test_to_dict(self):
        s = AnalyticsStats(total_invocations=20, unique_commands=5,
                           overall_success_rate=0.9, most_used_command="/evolve")
        d = s.to_dict()
