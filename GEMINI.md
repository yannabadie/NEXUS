...
**Note:** Swarm is OFF by default. Use `/swarm <task>` for explicit swarm mode, or set `SWARM_AUTO_ROUTE=True` in `.env` for automatic routing.
...
4. **Discover External Data** - Connect @external_sources, fetch documentation, APIs
