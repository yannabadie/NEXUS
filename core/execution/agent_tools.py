        ...
        return {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "context": {
                        "type": "string",
                        "description": "Additional context or code to analyze (optional)"
                    }
                },
                "required": ["task"]
            },
...
class AgentToolRegistry:
    ...
    def set_dependencies(
        ...
        agent_loader: "SpawnedAgentLoader"
    ) -> None:
        """
        ...
        for agent_profile in spawned:
            try:
                ...
                self._logger.warning(
                    f"Failed to create tool for agent {agent_profile.agent_id}: {e}"
                )
    ...
    def get_tool_definition(self, tool_name: str) -> Optional[AgentToolDefinition]:
        """
    ...
    def execute_agent_tool(
        ...
        if not self._agent_invoker:
            return AgentToolResult(
                ...
                output="",
                error="AgentInvoker not configured"
            )
