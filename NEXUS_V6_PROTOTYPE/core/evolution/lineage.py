...
def load_lineage(workspace_path: Path = None) -> Dict:
    ...
    if workspace_path:
        ...
        # Default: assume we're in NEXUS_V6_PROTOTYPE/core/evolution/
...
def create_child_entry(
    ...
    Args:
        ...
        asi_score: ASI proximity score (0.0 - 1.0)
    ...
    parent_score = parent["asi_proximity_score"]

    improvement_percent = (asi_score - parent_score) / parent_score if parent_score > 0 else 0
...
def promote_child_to_parent(
    ...
    Args:
        ...
        asi_score: Child's ASI proximity score
